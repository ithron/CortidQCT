...
-------:|:-------:|:----
**v1.0.1**  |  [CortidQCT-1.0.1-Windows-x64.zip](https://github.com/ithron/CortidQCT/releases/download/v1.0.1/CortidQCT_CLI-1.0.1-Windows-x64.zip) | Complete: CLI, library, headers, Matlab toolbox
